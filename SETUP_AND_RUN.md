...
### Create an Admin User (Local Example):

```php
$admin = \App\Models\User::create([
    'name' => 'Admin User',
    'email' => 'admin@local.invalid',
    'password' => bcrypt('set-a-strong-local-password')
]);
$admin->assignRole('admin');
```

### Create Intern Users (Local Example):

```php
$intern1 = \App\Models\User::create([
    'name' => 'John Intern',
    'email' => 'intern1@local.invalid',
    'password' => bcrypt('set-a-strong-local-password'),
...
### As an Intern:
1. Login as your local intern account (generated by script or tinker)
...
### As an Admin:
1. Login as your local admin account
2. **Manage Interns**:
